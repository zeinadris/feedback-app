...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="https://startbootstrap.com/template/sb-admin-2/img/undraw_profile.svg">
                            </a>
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Feedback Selesai
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                    ...
                    <!-- Content Row (Contoh Tabel) -->
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Daftar Feedback Terbaru</h6>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            @foreach ($feedbacks as $feedback)
                                                <tr>
                                                    ...
                                                    <td>{{ Str::limit($feedback->pesan, 30) }}</td> 
                                                    <td>
    ...
    <script>
        // Inisialisasi DataTables (jika menggunakan DataTables)
